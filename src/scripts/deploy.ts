...
const ainPrivateKey = process.env.PRIVATE_KEY ? process.env.PRIVATE_KEY : '';
const modelName = process.env.MODEL_NAME ? process.env.MODEL_NAME : '';
const modelUrl = process.env.MODEL_URL ? process.env.MODEL_URL : '';
